...
Select Location, Population, MAX(total_cases) as HighestInfectionCount,  MAX(CONVERT(float, population) / NULLIF(CONVERT(float, total_cases), 0))*100 as PercentofPopInfected
From Covid_portf..CovidDeaths
--Where location like '%states%'
